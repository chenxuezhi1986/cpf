...
class Database_Base
{
    ...
    public function set_cur_db_config($db_server_id)
    {
        if (isset($this->config[$db_server_id])) {
            $this->cur_db_config = $this->config[$db_server_id];
    ...
    static function get_instance()
    {
        ...
        self::$_instance = new Database_Base();
        return self::$_instance;
    }
